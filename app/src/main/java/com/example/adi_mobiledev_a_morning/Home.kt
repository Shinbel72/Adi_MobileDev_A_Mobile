...
import com.example.adi_mobiledev_a_morning.Data.DataAdapter
import com.example.adi_mobiledev_a_morning.Data.DataDatabaseHelper
import com.example.adi_mobiledev_a_morning.databinding.FragmentHomeBinding
...
class Home : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addButton.setOnClickListener {
            val intent = Intent(requireContext(), activity_add_data::class.java)
